...
pub fn part1(input: String) -> u64 {
    get_beacons(input, false)
}

pub fn part2(input: String) -> u64 {
    get_beacons(input, true)
}

type Fp = (i32, i32);

//largely adopted from timvisee
pub fn get_beacons(input: String, distance: bool) -> u64 {
